...
#Modeļa lejupielāde ar 4-bitu konfigurāciju un resursu ietaupīšanu
...
resursu_thread = threading.Thread(target=log_resources)
resursu_thread.start()
